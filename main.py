...
# ----------------------- CONFIG -----------------------
TOKEN = "8342300519:AAFBHujyOFnfGtgW4YxwGoq_Rjv8ZHWMGAo"
...
OWNER_ID = 7991268498  # <-- yaha apna Telegram ID daalo
...
def start(msg):
    ...
    if not is_subscribed(user_id):
        ...
        kb.add(
            telebot.types.InlineKeyboardButton(
                "💥 Join Our Channel 💥",
                url="https://t.me/+3N7sgBT1BZUyYTJl"
            )
        )
    ...
    kb.add(
        telebot.types.InlineKeyboardButton("👤 Owner", url="https://t.me/LookupscontactBot")
    )
